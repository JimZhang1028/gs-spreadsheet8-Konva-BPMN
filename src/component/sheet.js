...
/*
  //GUSA
    console.log("sync_sheets !!!");
  //GUSA
  if (this.sync_sheets) { //GUSA
    console.log("sync_sheets !!!");
    //this.sync_sheets[0].reload(); //GUSA
  }
 */ 
}
...
function rowResizerFinished(cRect, distance) {
  ...
  data.setRowHeight(ri, distance);  //GUSA
  table.render();
  selector.resetAreaOffset();
  verticalScrollbarSet.call(this);
  editorSetOffset.call(this);
...
function colResizerFinished(cRect, distance) {
  ...
  data.setColWidth(ci, distance); //GUSA
...
function show_diagram_bpmn_01(  diagramXML) {
...
export default class Sheet {
  constructor(targetEl, data) {
   ...
   //===========================================================  SVG PLAIN
    //GUSA
    this.svgEl = h('div', `${cssPrefix}-svg`);
    this.svgEl.css("position", "absolute");
    this.svgEl.css("top"     , "0px");
    this.svgEl.css("left"    , "0px");
    this.svgEl.css("width"    , "1000px");
    this.svgEl.css("height"    , "1000px");
 ...
 // create the svg element
    ...
    svg1.setAttribute("width" , view.width);
    svg1.setAttribute("height", view.height);

    // create a circle
    const cir1 = document. createElementNS("http://www.w3.org/2000/svg", "circle");
    cir1.setAttribute("cx", "0");
    cir1.setAttribute("cy", "0");
    cir1.setAttribute("r", "10");
    cir1.setAttribute("fill", "blue");

    // attach it to the container
    svg1.appendChild(cir1);

    this.svgEl.children(svg1);
*/
...
//    });
   ...
   //===========================================================
    ...
    //document.querySelector(`${cssPrefix}-svg`).appendChild(svg1);
    //this.overlayerEl.hide();//GUSA 

    sheetReset.call(this);

    //this.table.layerRender(); //GUSA TEST
    //
    // init selector [0, 0]
    selectorSet.call(this, false, 0, 0);
    //this.sync_sheets = new Array(); //GUSA
    this.sync_sheets = []; //GUSA
  }
  ...
  /*
  addSyncSheet(sheet) {  //GUSA
    //this.sync_sheet.push(sheet);
    this.sync_sheets[0]= sheet;
